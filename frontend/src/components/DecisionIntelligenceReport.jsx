...
export default function DecisionIntelligenceReport({ report, onClose }) {
  ...
  return (
    <div className="space-y-8 text-surface-100 max-w-5xl mx-auto print:text-black print:bg-white print:p-0">
      {/* HEADER BANNER — Section 13: Real-Time Workflow Summary */}
      <div className="rounded-2xl bg-gradient-to-r from-aegis-950/80 via-surface-900/90 to-indigo-950/80 border border-aegis-500/30 p-6 backdrop-blur-md print:border-none print:shadow-none">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-aegis-500/20 border border-aegis-400/30 text-aegis-400">
              <ShieldCheck size={26} />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold uppercase tracking-wider text-aegis-400">Enterprise Decision Intelligence Report</span>
                <Badge variant="success" size="sm">Decision Ready</Badge>
              </div>
              <h2 className="text-xl font-bold text-white mt-0.5">{caseTitle}</h2>
            </div>
          </div>
        ...
        {/* Status Highlights */}
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 pt-4 border-t border-surface-800/40 text-xs font-medium text-surface-300">
          <div className="flex items-center gap-2">
            <CheckCircle2 size={16} className="text-emerald-400 shrink-0" />
            <span>Investigation Completed</span>
          </div>
          <div className="flex items-center gap-2">
            <Layers size={16} className="text-aegis-400 shrink-0" />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Overall Confidence</p>
          <p className="text-2xl font-bold text-emerald-400 mt-1">{confidence}%</p>
          <span className="text-[10px] text-emerald-500/80 font-medium">High Precision</span>
        </div>
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Risk Score</p>
          <p className="text-2xl font-bold text-aegis-400 mt-1">{riskScore}%</p>
          <span className="text-[10px] text-aegis-400/80 font-medium">{riskMeta.severity} Risk</span>
        </div>
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Evidence Count</p>
          <p className="text-2xl font-bold text-indigo-400 mt-1">{evidenceList.length} Items</p>
          <span className="text-[10px] text-indigo-400/80 font-medium">Cross-Verified</span>
        </div>
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Agents Completed</p>
          <p className="text-2xl font-bold text-purple-400 mt-1">6 / 6</p>
          <span className="text-[10px] text-purple-400/80 font-medium">Sequential Flow</span>
        </div>
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Execution Time</p>
          <p className="text-2xl font-bold text-white mt-1">1.49s</p>
          <span className="text-[10px] text-surface-400 font-medium">Real-time Pipeline</span>
        </div>
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Decision Quality</p>
          <p className="text-2xl font-bold text-emerald-400 mt-1">{quality}%</p>
          <span className="text-[10px] text-emerald-500/80 font-medium">Enterprise Grade</span>
        </div>
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Reliability Score</p>
          <p className="text-2xl font-bold text-indigo-400 mt-1">{reliability}%</p>
          <span className="text-[10px] text-indigo-400/80 font-medium">Validated</span>
        </div>
        <div className="rounded-xl bg-surface-900/60 border border-surface-700/40 p-4">
          <p className="text-xs text-surface-400 font-medium">Completion Status</p>
          <p className="text-2xl font-bold text-emerald-400 mt-1 capitalize">{decision}</p>
          <span className="text-[10px] text-emerald-500/80 font-medium">Final Audit Logged</span>
        </div>
      </div>

      {/* SECTION 1: EXECUTIVE SUMMARY */}
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-3">
        <div className="flex items-center gap-2 text-aegis-400">
          <FileText size={20} />
          <h3 className="text-lg font-bold text-white">1. Executive Summary</h3>
        </div>
        <p className="text-sm text-surface-200 leading-relaxed">{summaryText}</p>
        <div className="p-4 rounded-xl bg-surface-950/60 border border-surface-800/40 text-xs text-surface-300 space-y-1">
          <p><span className="font-semibold text-white">Case Title:</span> {caseTitle}</p>
          <p><span className="font-semibold text-white">Investigation Focus:</span> Multi-agent operational risk, evidence validation, compliance verification, and actionable roadmap generation.</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-4">
        <div className="flex items-center gap-2 text-indigo-400">
          <Target size={20} />
          <h3 className="text-lg font-bold text-white">2. Problem Analysis</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 rounded-xl bg-surface-950/50 border border-surface-800/40">
            <h4 className="text-xs font-bold text-aegis-300 uppercase tracking-wider mb-2">Root Cause Analysis</h4>
            <ul className="space-y-1.5 text-xs text-surface-300">
              {rootCauses.map((item, idx) => (
                <li key={idx} className="flex items-start gap-1.5">
                  <span className="text-aegis-400 font-bold">•</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="p-4 rounded-xl bg-surface-950/50 border border-surface-800/40">
            <h4 className="text-xs font-bold text-indigo-300 uppercase tracking-wider mb-2">Key Challenges Identified</h4>
            <ul className="space-y-1.5 text-xs text-surface-300">
          ...
          <div className="p-4 rounded-xl bg-surface-950/50 border border-surface-800/40">
            <h4 className="text-xs font-bold text-purple-300 uppercase tracking-wider mb-2">Important Assumptions</h4>
            <ul className="space-y-1.5 text-xs text-surface-300">
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-4">
        <div className="flex items-center gap-2 text-purple-400">
          <Layers size={20} />
          <h3 className="text-lg font-bold text-white">3. Multi-Agent Execution Timeline</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {timelineAgents.map((agent) => (
            <div key={agent.name} className="p-4 rounded-xl bg-surface-950/60 border border-surface-800/40 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-white">{agent.name}</span>
                <Badge variant="success" size="sm">{agent.time}</Badge>
              </div>
              <p className="text-[11px] font-semibold text-aegis-300">{agent.goal}</p>
              <p className="text-xs text-surface-400 leading-normal">{agent.contrib}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-4">
        <div className="flex items-center gap-2 text-emerald-400">
          <Activity size={20} />
          <h3 className="text-lg font-bold text-white">4. AI Confidence & Quality Metrics</h3>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-medium">
              <span className="text-surface-300">Overall Confidence</span>
            ...
            <div className="h-2.5 w-full bg-surface-800 rounded-full overflow-hidden">
              <motion.div initial={{ width: 0 }} animate={{ width: `${confidence}%` }} transition={{ duration: 1 }} className="h-full bg-gradient-to-r from-aegis-500 to-emerald-400 rounded-full" />
            </div>
          </div>

          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-medium">
              <span className="text-surface-300">Reliability Score</span>
              <span className="text-indigo-400 font-bold">{reliability}%</span>
            </div>
            <div className="h-2.5 w-full bg-surface-800 rounded-full overflow-hidden">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-medium">
              <span className="text-surface-300">Data Completeness</span>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-medium">
              <span className="text-surface-300">Prediction Quality</span>
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-4">
        <div className="flex items-center gap-2 text-amber-400">
          ...
          <h3 className="text-lg font-bold text-white">5. Risk Assessment & Justification</h3>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center">
          <div className="p-3 rounded-xl bg-surface-950/60 border border-surface-800/40">
            <p className="text-[10px] text-surface-400 uppercase font-semibold">Overall Risk</p>
            <p className="text-lg font-bold text-aegis-400 mt-0.5">{riskScore}%</p>
          </div>
          <div className="p-3 rounded-xl bg-surface-950/60 border border-surface-800/40">
            <p className="text-[10px] text-surface-400 uppercase font-semibold">Severity</p>
            <p className="text-sm font-bold text-emerald-400 mt-1">{riskMeta.severity}</p>
          </div>
          <div className="p-3 rounded-xl bg-surface-950/60 border border-surface-800/40">
            <p className="text-[10px] text-surface-400 uppercase font-semibold">Probability</p>
            <p className="text-sm font-bold text-indigo-400 mt-1">{riskMeta.probability}</p>
          </div>
          <div className="p-3 rounded-xl bg-surface-950/60 border border-surface-800/40">
            <p className="text-[10px] text-surface-400 uppercase font-semibold">Impact</p>
            <p className="text-sm font-bold text-purple-400 mt-1">{riskMeta.impact}</p>
          </div>
          <div className="p-3 rounded-xl bg-surface-950/60 border border-surface-800/40">
            <p className="text-[10px] text-surface-400 uppercase font-semibold">Urgency</p>
            <p className="text-sm font-bold text-amber-400 mt-1">{riskMeta.urgency}</p>
          </div>
        </div>

        <div className="p-4 rounded-xl bg-surface-950/60 border border-surface-800/40">
          <h4 className="text-xs font-bold text-amber-300 uppercase tracking-wider mb-1">Why this Risk Score was assigned</h4>
          <p className="text-xs text-surface-300 leading-relaxed">{riskMeta.reasoning}</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-4">
        <div className="flex items-center gap-2 text-aegis-400">
          <Layers size={20} />
          <h3 className="text-lg font-bold text-white">6. Evidence Summary</h3>
        </div>

        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-surface-800/60 text-surface-400 font-semibold">
            ...
            <tbody className="divide-y divide-surface-800/30">
              {evidenceList.map((item, idx) => (
                <tr key={idx} className="hover:bg-surface-850/30">
                  <td className="py-2.5 font-medium text-white">{item.source}</td>
                  <td className="py-2.5 text-surface-400">{item.type}</td>
                  <td className="py-2.5 text-surface-300">{item.detail}</td>
                  <td className="py-2.5">
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-4">
        <div className="flex items-center gap-2 text-emerald-400">
          <Brain size={20} />
          <h3 className="text-lg font-bold text-white">7. Decision Reasoning & Comparison</h3>
        </div>

        <div className="space-y-3 text-xs text-surface-200">
          <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
            <h4 className="font-bold text-emerald-300 mb-1">Why &apos;{decision.toUpperCase()}&apos; Was Selected</h4>
            <p className="leading-relaxed text-surface-200">{reasoning.why_selected}</p>
          </div>

          <div className="p-4 rounded-xl bg-surface-950/60 border border-surface-800/40">
            <h4 className="font-bold text-surface-300 mb-2">Why Alternative Options Were Rejected</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-xl bg-surface-950/60 border border-surface-800/40">
              <h4 className="font-bold text-aegis-300 mb-1">Expected Outcome</h4>
              <p className="text-surface-400">{reasoning.expected_outcome}</p>
            </div>
            <div className="p-3.5 rounded-xl bg-surface-950/60 border border-surface-800/40">
              <h4 className="font-bold text-purple-300 mb-1">Possible Limitations</h4>
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-4">
        <div className="flex items-center gap-2 text-aegis-400">
          <Clock size={20} />
          <h3 className="text-lg font-bold text-white">8. Prioritized Action Plan Roadmap</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-4 rounded-xl bg-aegis-500/10 border border-aegis-500/20 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-aegis-300 uppercase">Immediate Actions</span>
              <Badge variant="aegis" size="sm">24-48 Hours</Badge>
            </div>
            {actionPlan.immediate?.map((item, idx) => (
              <p key={idx} className="text-surface-200 flex items-start gap-1.5">
                <ChevronRight size={14} className="text-aegis-400 shrink-0 mt-0.5" />
          ...
          <div className="p-4 rounded-xl bg-indigo-500/10 border border-indigo-500/20 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-indigo-300 uppercase">Short-Term Actions</span>
          ...
          <div className="p-4 rounded-xl bg-purple-500/10 border border-purple-500/20 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-purple-300 uppercase">Long-Term Actions</span>
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-3">
        <div className="flex items-center gap-2 text-indigo-400">
          <HelpCircle size={20} />
          <h3 className="text-lg font-bold text-white">9. Explainability Panel (Plain English XAI)</h3>
        </div>
        <div className="p-4 rounded-xl bg-surface-950/60 border border-surface-800/40 text-xs text-surface-200 leading-relaxed">
          {explainability}
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-surface-900/50 border border-surface-700/30 p-6 space-y-3">
        <div className="flex items-center gap-2 text-emerald-400">
          <Zap size={20} />
          <h3 className="text-lg font-bold text-white">14. Case-Specific Smart AI Recommendations</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
          {recommendations.map((rec, idx) => (
            <div key={idx} className="flex items-start gap-2.5 p-3 rounded-xl bg-surface-950/50 border border-surface-800/30">
              <div className="p-1 rounded-full bg-emerald-500/20 text-emerald-400 shrink-0 mt-0.5">
                <CheckCircle2 size={14} />
              </div>
              <span className="text-surface-200 leading-relaxed">{rec}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-gradient-to-r from-aegis-950/90 via-surface-900/90 to-indigo-950/90 border border-aegis-500/40 p-6 space-y-3">
        <div className="flex items-center gap-2 text-aegis-300">
          <ShieldCheck size={22} />
          <h3 className="text-lg font-bold text-white">15. Executive Conclusion</h3>
        </div>
        <p className="text-sm text-surface-200 leading-relaxed font-medium">
          {conclusion}
        </p>
        <div className="pt-3 border-t border-surface-800/40 flex items-center justify-between text-xs text-surface-400">
